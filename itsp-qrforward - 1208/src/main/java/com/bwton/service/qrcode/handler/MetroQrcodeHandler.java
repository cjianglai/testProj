 ...
 * @Project: itsp-parent
 * @Package: com.bwton.service.qrcode.handler
 * @Name: MetroQrcodeHandler
 * @Author: zhaokaikai@bwton.com
 * @Date: 2017年11月02日 09时34分
 * @Description: MetroQrcodeHandler
 */
@Slf4j
@Component("metroQrcodeHandler")
public class MetroQrcodeHandler implements QrcodeHandler {
    ...
    public String RequestQrcode(QrcodeParam qrcodeParam,
        ...
        ,userId = qrcodeParam.getUser_id()//用户ID
        ,appId = systemParams.get(QrcodeContant.APP_ID)//App_Id
        ,appSecret = systemParams.get(QrcodeContant.APP_SECRET)//App_Secret
        ,serviceId = qrcodeParam.getService_id()//Service_id
        ,cityId = qrcodeParam.getCity_id()//City_id
        ,tripNo = "0"//tripNo
        ,busi_data = qrcodeParam.getQr_code()
        ,reserved = effectTime;
